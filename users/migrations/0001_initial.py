    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aadhar_no', models.CharField(max_length=12, primary_key=True, serialize=False, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vehicle_type', models.CharField(choices=[('MCWOG', 'Motorcycle without gear'), ('MCWG', 'Motorcycle with gear'), ('LMV', 'Light Motor Vehicle'), ('HMV', 'Heavy Motor Vehicle')], max_length=5)),
